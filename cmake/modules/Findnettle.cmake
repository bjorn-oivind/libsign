...
find_path(Nettle_INCLUDE_DIR NAMES nettle-types.h
          ...
          PATH "$ENV{PROGRAMFILES}/nettle/include"
          DOC "The Nettle include directory"
)

find_library(Nettle_LIBRARY NAMES nettle
             PATH "$ENV{PROGRAMFILES}/nettle/lib"
...
if(WIN32)
  ...
  find_library(Gmp_LIBRARY NAMES mpir
               PATH "$ENV{PROGRAMFILES}/mpir/lib"
...
if(WIN32)
  find_package_handle_standard_args(Nettle DEFAULT_MSG Nettle_LIBRARY Nettle_INCLUDE_DIR Gmp_LIBRARY)
else(WIN32)
  find_package_handle_standard_args(Nettle DEFAULT_MSG Nettle_LIBRARY Nettle_INCLUDE_DIR Hogweed_LIBRARY Gmp_LIBRARY)
endif()
...
mark_as_advanced(Nettle_INCLUDE_DIR Nettle_LIBRARY Hogweed_LIBRARY Gmp_LIBRARY)
